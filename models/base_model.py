...
class CNNmodel(nn.Module):
    def __init__(self, input_dim, hidden_dim, num_layer=3, dropout=0.2):
        ...
        self.cnn_layer0 = nn.Conv1d(self.input_dim, self.hidden_dim, kernel_size=1, padding=0) # 一维卷积
        self.cnn_layers = nn.ModuleList(nn.Conv1d(self.hidden_dim, self.hidden_dim, kernel_size=7, padding=3) for i in range(self.num_layer-1)) #
        # kernel size 一般取奇数，padding 相应取一半
